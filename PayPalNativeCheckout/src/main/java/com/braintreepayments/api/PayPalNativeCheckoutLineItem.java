...
public class PayPalNativeCheckoutLineItem implements Parcelable {
    ...
    @interface PayPalNativeCheckoutLineItemKind {
    }
     ...
     *
     * @param kind       The {@link PayPalNativeCheckoutLineItemKind} kind.
     * @param name       The name of the item to display.
     * @param quantity   The quantity of the item.
     * @param unitAmount The unit amount.
     */
    public PayPalNativeCheckoutLineItem(@NonNull @PayPalNativeCheckoutLineItemKind String kind,
                                        @NonNull String name,
     ...
     * @param kind The {@link PayPalNativeCheckoutLineItemKind} kind.
     */
    public void setKind(@NonNull @PayPalNativeCheckoutLineItemKind String kind) {
        this.kind = kind;
    }
    ...
    @PayPalNativeCheckoutLineItemKind
    @Nullable
